...
mod tests {
    use super::*;
    use crate::render::resources::materials::{StandardMaterialParams, MaterialType};
    
    fn create_test_material() -> Material {
        Material {
            material_type: MaterialType::StandardPBR(StandardMaterialParams::default()),
            textures: crate::render::resources::materials::MaterialTextures::new(),
            id: crate::render::resources::materials::MaterialId(0),
