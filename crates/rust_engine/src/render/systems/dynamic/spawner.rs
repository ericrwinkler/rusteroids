...
use crate::render::systems::dynamic::resource_pool::MaterialProperties;
...
impl DefaultDynamicSpawner {
    ...
    pub fn get_active_objects(&self) -> std::collections::HashMap<DynamicObjectHandle, crate::render::systems::dynamic::DynamicRenderData> {
    ...
    where 
        F: FnMut(DynamicObjectHandle, &crate::render::systems::dynamic::DynamicRenderData),
    {
