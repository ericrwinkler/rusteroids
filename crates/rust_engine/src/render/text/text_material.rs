...
use crate::render::material::{Material, UnlitMaterialParams, StandardMaterialParams, TextureHandle};
...
/// Legacy alias for `create_unlit_text_material`
///
/// Maintained for backward compatibility. Prefer using the explicit
/// `create_lit_text_material` or `create_unlit_text_material` functions.
#[deprecated(since = "0.1.0", note = "Use create_lit_text_material or create_unlit_text_material")]
pub fn create_text_material(
    font_atlas_texture: TextureHandle,
    color: Vec3,
) -> Material {
    create_unlit_text_material(font_atlas_texture, color)
}
...
mod tests {
    ...
    fn test_lit_text_material() {
        ...
        assert_eq!(material.required_pipeline(), crate::render::material::PipelineType::TransparentPBR);
    ...
    fn test_unlit_text_material() {
        ...
        assert_eq!(material.required_pipeline(), crate::render::material::PipelineType::TransparentUnlit);
